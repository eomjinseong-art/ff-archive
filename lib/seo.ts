...
const CAR_TITLES: Record<string, string> = {
  ...
  "buick-grand-national-1987": "분노의 질주 그랜드 내셔널",
  "ford-mustang-shelby-gt350-2015": "분노의 질주 GT350",
  "jeep-gladiator-2020": "분노의 질주 글래디에이터",
  "jeep-wrangler-rubicon-furious7": "분노의 질주 랭글러",
  "dodge-viper-furious7": "분노의 질주 검은 바이퍼",
  "chevrolet-corvette-grand-sport-replica": "분노의 질주 콜벳 GS",
