...
export const crew: ArchivePerson[] = [
  ...
  },
  {
    ...
    bio: [
      ...
      "위키백과는 이 인물이 저스틴 린의 《베터 럭 투모로우》에서 왔고, 린과 성강이 같은 인물이라고 확인해 그 영화가 기원이 된다고 적습니다. 그 작품은 이 아카이브의 본편 목록에 넣지 않습니다. 2009년 작품에 짧게 나온 뒤 언리미티드와 더 맥시멈의 주요 인물이 되고, 더 얼티메이트에서 살아 있음이 드러나 분노의 질주: 라이드 오어 다이까지 이어집니다.",
    ],
